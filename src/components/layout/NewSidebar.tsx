    ...
    <>
      ...
      <aside
        className={cn(
          ...
          "bg-gradient-to-b from-white to-green-50 dark:bg-gray-900 border-r dark:border-gray-800 flex flex-col shadow-md"
        )}
      >
        {/* Header with logo */}
        <div className="h-16 flex items-center px-4 border-b dark:border-gray-800 bg-gradient-to-r from-green-600 to-green-700">
          <div className={cn(
            ...
            {isOpen ? (
              <>
                ...
                <button 
                  onClick={toggle}
                  className="p-1 rounded-full hover:bg-green-500 text-white"
              ...
              <>
                ...
                <button 
                  onClick={toggle}
                  className="absolute right-0 p-1 rounded-full hover:bg-green-500 text-white -mr-3 bg-green-600 border border-green-500"
                ...
                <li key={item.name}>
                  <NavLink
                    ...
                    className={({ isActive }) => cn(
                      ...
                      isActive 
                        ? "bg-pec-green text-white shadow-md" 
                        : "text-gray-700 dark:text-gray-200 hover:bg-green-100 dark:hover:bg-gray-800"
                    )}
                  >
                          ...
                          <li key={subItem.name}>
                            <NavLink
                              ...
                              className={({ isActive }) => cn(
                                ...
                                isActive 
                                  ? "bg-green-100 text-pec-green font-medium" 
        ...
        {/* Footer */}
        {isOpen && (
          <div className="p-4 border-t dark:border-gray-800 bg-green-50/50">
