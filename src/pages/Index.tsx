...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-white to-gray-100">
      <div className="text-center max-w-2xl mx-auto px-4 space-y-8 animate-fade-in">
        <img 
        ...
        <Link to="/login">
          <Button 
            className="bg-pec-green hover:bg-pec-green-600 transition-colors duration-300 text-lg px-8 py-6 h-auto rounded-lg"
          >
