...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white">
      <div className="text-center max-w-2xl mx-auto px-4 space-y-4 animate-fade-in">
        <img 
        ...
        <div>
          <Link to="/login">
            <Button 
              className="bg-pec-green hover:bg-pec-green-600 transition-colors duration-300 text-sm px-4 py-1.5 h-auto rounded-lg"
            >
